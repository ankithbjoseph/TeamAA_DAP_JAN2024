...
FlightsDataFrame = create_dagster_pandas_dataframe_type(
    ...
    columns=[
        ...
        PandasColumn.string_column(name="origin.id", non_nullable=True),
        PandasColumn.string_column(name="origin.city", non_nullable=True),
        PandasColumn.string_column(name="origin.country", non_nullable=True),
        PandasColumn.string_column(name="origin.iata_code", non_nullable=True),
        PandasColumn.float_column(name="origin.latitude", non_nullable=True),
        PandasColumn.float_column(name="origin.longitude", non_nullable=True),
        PandasColumn.float_column(name="origin.elevation", non_nullable=True),
        PandasColumn.string_column(name="destination.id", non_nullable=True),
        PandasColumn.string_column(name="destination.city", non_nullable=True),
        PandasColumn.string_column(name="destination.country", non_nullable=True),
        PandasColumn.string_column(name="destination.iata_code", non_nullable=True),
        PandasColumn.float_column(name="destination.latitude", non_nullable=True),
        PandasColumn.float_column(name="destination.longitude", non_nullable=True),
        PandasColumn.float_column(name="destination.elevation", non_nullable=True),
        PandasColumn.string_column(name="aircraft.callsign", non_nullable=True),
        PandasColumn.string_column(name="aircraft.name", non_nullable=True),
        PandasColumn.string_column(name="aircraft.operator.name", non_nullable=True),
        PandasColumn.string_column(
            name="aircraft.operator.callsign", non_nullable=True
        ),
        PandasColumn.string_column(
            name="aircraft.operator.iata_code", non_nullable=True
        ),
        PandasColumn.string_column(
            name="aircraft.operator.icao_code", non_nullable=True
        ),
        PandasColumn.string_column(name="aircraft.operator.country", non_nullable=True),
        PandasColumn.string_column(name="aircraft.manufacturer", non_nullable=True),
        PandasColumn.string_column(name="aircraft.model", non_nullable=True),
        PandasColumn.string_column(name="aircraft.manufacturer", non_nullable=True),
        ...
        PandasColumn.string_column(name="aircraft.enginetype", non_nullable=True),
        PandasColumn.string_column(name="departure.scheduled", non_nullable=True),
        PandasColumn.string_column(name="departure.actual", non_nullable=True),
        PandasColumn.string_column(name="arrival.scheduled", non_nullable=True),
        PandasColumn.string_column(name="arrival.actual", non_nullable=True),
    ],
)
...
WeatherDataFrame = create_dagster_pandas_dataframe_type(
    ...
    columns=[
        PandasColumn.datetime_column(name="datetime", non_nullable=True),
        PandasColumn.numeric_column(
            name="pressure", min_value=920, max_value=1060, non_nullable=True
        ),
        PandasColumn.numeric_column(
            name="rain", min_value=0, max_value=20, non_nullable=True
        ),
        PandasColumn.integer_column(
            name="wind_direction", min_value=0, max_value=360, non_nullable=True
        ),
        PandasColumn.numeric_column(
            name="wind_speed", min_value=0, max_value=200, non_nullable=True
        ),
    ],
)
...
def transform_weather(start):
    ...
    weather_df = pd.DataFrame(list(cassandra_session.execute("SELECT * FROM weather;")))
...
@op(ins={"start": In(bool)}, out=Out(FlightsDataFrame))
...
def join(flights_df, weather_df) -> pd.DataFrame:
    ...
    merged_df = flights_df.merge(
        right=weather_df, how="left", left_on="date", right_on="datetime"
    )
